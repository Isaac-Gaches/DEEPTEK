...
/// Atlas behaviour understood by the instanced decoration renderer. Static and
/// growth-frame decorations require no renderer changes; segmented growth is a
/// separate reusable form for vines and similar hanging objects.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum DecorationVisual {
    GrowthFrames { first_frame: u16, stages: u8 },
    Static { frame: u16 },
...
pub const BUILT_IN_DECORATIONS: &[DecorationDefinition] = &[
    ...
    DecorationDefinition::new(
        ...
        "Pebble",
        DecorationVisual::Static { frame: 2 },
        None,
    ),
    DecorationDefinition::new(
        NaturalObject::VINE,
