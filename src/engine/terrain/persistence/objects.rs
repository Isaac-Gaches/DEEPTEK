use super::*;
use crate::{
    CargoLiftDirection, FurnitureBehavior, FurnitureDefinition, Layer, POWERED_CABLE_OBJECT,
    ROPE_OBJECT,
};
    ...
    for object in &store.objects {
            ...
            .is_some_and(|definition| definition.behavior() == FurnitureBehavior::CargoLift)
        {
            ...
            let maximum = cable
                .anchor
                .y
                .checked_add(u32::from(cable.height).saturating_sub(u32::from(object.height)));
            if cable.height < object.height
                || maximum.is_none()
                || {
