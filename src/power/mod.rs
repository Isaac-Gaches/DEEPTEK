...
fn consumer_is_demanding(world: &World, object: ObjectId) -> bool {
    ...
    match object.object_type() {
        crate::FurnitureObject::LASER_BORE
        | crate::FurnitureObject::TURRET
        | crate::FurnitureObject::AMMO_TURRET
        | crate::FurnitureObject::DIRECTIONAL_SENTRY
        | crate::FurnitureObject::COMPOSITE_ASSEMBLER
        | crate::FurnitureObject::RED_SHAFT_BORE
        | crate::FurnitureObject::LASER_DRILL
        | crate::FurnitureObject::SUBSURFACE_SURVEYOR => object.is_active(),
